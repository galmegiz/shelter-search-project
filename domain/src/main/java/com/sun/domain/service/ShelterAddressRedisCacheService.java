...
@ConditionalOnProperty(prefix = "spring.config.activate", name = "on-profile", havingValue = "db")
public class ShelterAddressRedisCacheService implements ShelterAddressCacheService{
    ...
    public void init() {
        ...
        log.info("redis cache is initiated");
    }
    @Override
